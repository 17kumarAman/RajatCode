...
const Page = () => {
  ...
  <section className="right-sectionEcom">
    <div className="content-blockEcom">
      <h3>1. BigCommerce Store Custom Development
      </h3>
      <p>
    ...
    <div className="content-blockEcom">
      <h3>2. BigCommerce Store Optimization
      </h3>
      <p>
    ...
    <div className="content-blockEcom">
      <h3>3. BigCommerce Theme Design</h3>
      <p>
    ...
    <div className="content-blockEcom">
      <h3>4. BigCommerce App Integration
      </h3>
      <p>
     ...
     <div className="content-blockEcom">
      <h3>5. BigCommerce Migration Services</h3>
      <p>
    ...
    <div className="content-blockEcom">
      <h3>6. BigCommerce SEO & Marketing
      </h3>
      <p>
